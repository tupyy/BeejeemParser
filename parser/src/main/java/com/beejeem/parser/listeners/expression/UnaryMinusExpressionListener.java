...
public class UnaryMinusExpressionListener extends AbstractListener {
    private Value value;

    public UnaryMinusExpressionListener(ExecutionContext executionContext) {
    ...
    public void enterUnaryMinusExpression(bjmParser.UnaryMinusExpressionContext ctx) {
        ...
        expressionListener.enterRule(ctx.expression());
